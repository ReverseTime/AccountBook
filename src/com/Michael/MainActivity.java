...
public class MainActivity extends Activity {
    ...
    public void init() {
        ...
        //收入类型
        arrIncome = new String[]{"工资","外快"};
        spinner =(Spinner) findViewById(R.id.spinner1);
        final ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, android.R.id.text1, arrIncome);
